...
jcf.addModule(function (e, t) {
  ...
  var n = {
    ...
    plugins: { ListBox: i, ComboBox: s, SelectList: o },
    ...
    refresh: function () {
      var e =
        (this.isListBox() && this.instance instanceof s) ||
        (!this.isListBox() && this.instance instanceof i);
  ...
  e.extend(s.prototype, {
    ...
    initStructure: function () {
      (this.win = e(t)),
        ...
        (this.fakeElement = e(this.options.fakeAreaStructure).insertAfter(
          this.realElement
        )),
        (this.selectTextContainer = this.fakeElement.find(
          this.options.selectTextSelector
        )),
        (this.selectText = e("<span></span>").appendTo(
          this.selectTextContainer
        )),
        r(this.fakeElement),
        this.fakeElement.addClass(
          l(this.realElement.prop("className"), this.options.selectClassPrefix)
        ),
    ...
    onSelectAreaPress: function (t) {
      var s =
        ...
        e(t.target).closest(this.dropdown).length;
      s ||
        t.button > 1 ||
        this.realElement.is(":disabled") ||
        ((this.selectOpenedByEvent = t.pointerType),
        this.toggleDropdown(),
        this.focusedFlag ||
          ("mouse" === t.pointerType
    ...
    onOutsideClick: function (t) {
      var s = e(t.target),
        i =
          s.closest(this.fakeElement).length || s.closest(this.dropdown).length;
      i || this.hideDropdown();
    },
    onSelect: function () {
      this.refresh(),
    ...
    createDropdown: function () {
      this.dropdown && (this.list.destroy(), this.dropdown.remove()),
        (this.dropdown = e(this.options.fakeDropStructure).appendTo(
          this.fakeDropTarget
        )),
    ...
    refreshSelectedText: function () {
      ...
      this.realElement.prop("multiple")
        ...
        ? (this.currentSelectedText !== i.innerHTML ||
          ...
          ((t = l(i.className, this.options.optionClassPrefix)),
          this.selectText.attr("class", t).html(i.innerHTML),
          o
            ? (this.selectImage ||
                (this.selectImage = e("<img>")
    ...
    e.extend(i.prototype, {
      ...
      initStructure: function () {
        (this.realElement = e(this.options.element)),
          (this.fakeElement = e(this.options.fakeStructure).insertAfter(
            this.realElement
          )),
    ...
    e.extend(o.prototype, {
      ...
      initStructure: function () {
        (this.element = e(this.options.element)),
          ...
          (this.container = e(this.options.containerStructure).appendTo(
            this.options.holder
          )),
      ...
      onSelectItem: function (t) {
        var s,
          i = parseFloat(
            t.currentTarget.getAttribute(this.options.indexAttribute)
          ),
      ...
      rebuildList: function () {
        ...
        return (
          ...
          this.options.useCustomScroll && jcf.modules.Scrollable)
            ? void jcf.replace(this.listHolder, "Scrollable", {
            ...
            : void (
                ...
                ((this.preventWheelHandler = function (e) {
                  var s = t.listHolder.scrollTop(),
                    i =
                      t.listHolder.prop("scrollHeight") -
                      t.listHolder.innerHeight();
                  ((0 >= s && e.deltaY < 0) || (s >= i && e.deltaY > 0)) &&
                    e.preventDefault();
                }),
      ...
      getSelectedIndexRange: function () {
        var e = -1,
          t = -1;
        return (
          this.realOptions.each(function (s, i) {
      ...
      getChangedSelectedIndex: function () {
        ...
        return this.element.prop("multiple")
          ? (this.previousRange || (this.previousRange = [t, t]),
      ...
      createOption: function (e) {
        ...
        return (
          ...
          e.className &&
            (t.className +=
              " " + l(e.className, this.options.cloneClassPrefix)),
          t
        );
      },
      ...
      createOptionsList: function (t) {
        ...
        return (
          e.each(t.children, function (e, t) {
            var o,
